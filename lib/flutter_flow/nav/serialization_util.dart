  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SqliteRow:
        ...
        switch (T) {
          case GetBudgetsRow:
            return GetBudgetsRow(data);
          case GetBudgetFolderRow:
            return GetBudgetFolderRow(data);
          case GetNotificationsRow:
            return GetNotificationsRow(data);
          case SumRevenueRow:
            return SumRevenueRow(data);
          case FilterByYearRow:
            return FilterByYearRow(data);
          case SumExpenseRow:
            return SumExpenseRow(data);
          case SumNETRow:
            return SumNETRow(data);
          case ForeignRevenueRow:
            return ForeignRevenueRow(data);
          case ForeignExpenseRow:
            return ForeignExpenseRow(data);
          case ForeignNETRow:
            return ForeignNETRow(data);
          case GetFolderDropdownRow:
            return GetFolderDropdownRow(data);
          case GetBudgetsFiltersRow:
            return GetBudgetsFiltersRow(data);
          case GetFolderDropYearRow:
            return GetFolderDropYearRow(data);
          case FilterFolderRow:
            return FilterFolderRow(data);
          case GetDuplicateRow:
            return GetDuplicateRow(data);
          case YearlyCALCRow:
            return YearlyCALCRow(data);
          case SearchFolderRow:
            return SearchFolderRow(data);
          case SearchBudgetsRow:
            return SearchBudgetsRow(data);
          case GetFolderIDRow:
            return GetFolderIDRow(data);
          default:
            return null;
        }
