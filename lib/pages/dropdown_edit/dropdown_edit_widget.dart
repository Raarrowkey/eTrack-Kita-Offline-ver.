                    ...
                    await showModalBottomSheet(
                      ...
                      builder: (context) {
                        return Padding(
                          ...
                          child: FolderEditWidget(
                            folderIDPARAM: widget.folderIDPARAM!,
                            folderNamePARAM: widget.folderNamePARAM,
              ...
              InkWell(
                ...
                onTap: () async {
                  ...
                  if (confirmDialogResponse) {
                    await SQLiteManager.instance.deleteBudgetFolder(
                      id: widget.folderIDPARAM!,
                    );
                    await SQLiteManager.instance.deleteCascade(
                      id: widget.folderIDPARAM!,
                    );
                    unawaited(
                      () async {
                        await SQLiteManager.instance.addNotifications(
                          ...
                          actionType: 'Deleted',
                          titleFolder: '[${widget.folderNamePARAM}]folder',
                    ...
                    unawaited(
                      () async {
                        await actions.scheduleNotification(
                          ...
                          'Folder Deleted!',
                          '${widget.folderNamePARAM} has been deleted',
                            ...
                            onPressed: () async {
                              ...
                              if (confirmDialogResponse) {
                                await actions.scheduleNotification(
                                  getCurrentTimestamp.secondsSinceEpoch,
                                  'Folder Deleted!',
                                  'Folder [Insert] has been deleted',
