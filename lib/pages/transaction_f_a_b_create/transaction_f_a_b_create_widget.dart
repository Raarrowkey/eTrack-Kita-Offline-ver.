...
import 'transaction_f_a_b_create_model.dart';
export 'transaction_f_a_b_create_model.dart';

class TransactionFABCreateWidget extends StatefulWidget {
  const TransactionFABCreateWidget({
    super.key,
  ...
  static String routeName = 'Transaction_FABCreate';
  static String routePath = '/transactionFABCreate';

  @override
  State<TransactionFABCreateWidget> createState() =>
      _TransactionFABCreateWidgetState();
}

class _TransactionFABCreateWidgetState
    extends State<TransactionFABCreateWidget> {
  late TransactionFABCreateModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TransactionFABCreateModel());
                                  ...
                                  onPressed: () async {
                                    if ((_model.choiceChipsValue == null ||
                                      ...
                                      if (_model.choiceChipsValue ==
                                        ...
                                        await SQLiteManager.instance.addBudgets(
                                          title: _model
                                        ...
                                        () async {
                                          await actions.scheduleNotification(
                                            getCurrentTimestamp
                                                .secondsSinceEpoch,
                                            'Transaction Added!',
                                            '${_model.titleTextFieldTextController.text} ${_model.choiceChipsValue} has been added',
